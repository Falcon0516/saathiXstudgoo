...
const terminalLines = [
  ...
  { text: "> [SHIELD] Origin identity masked via Secure Proxy", delay: 700, color: "#0EA5E9" },
  ...
  { text: "> [BRIDGE] Routing masked connection...", delay: 2800, color: "#6366F1" },
  { text: "> ✓ Bidirectional channel established", delay: 3400, color: "#0EA5E9" },
];
      ...
      <div style={{ padding: "32px 36px 0", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            <div className="glow-pulse-aurora" style={{ width: 8, height: 8, borderRadius: "50%", background: "#6366F1" }} />
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#6366F1" }}>
              Simulation 2
            </span>
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 16px", borderRadius: 12, background: "rgba(99,102,241,0.08)", border: "1px solid rgba(99,102,241,0.15)" }}>
        ...
        {stage === 0 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2, ...spring }}
              ...
              <div style={{ width: 44, height: 44, borderRadius: 14, background: "rgba(99,102,241,0.1)", border: "1px solid rgba(99,102,241,0.15)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <div style={{ fontSize: 14, fontWeight: 700, color: "#0EA5E9" }}>₹200/hr</div>
              </div>
            </motion.div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 60, marginBottom: 48 }}>
              ...
              <motion.div initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.5, ...spring }} className="float-zero-g" style={{ textAlign: "center" }}>
                <div style={{ width: 72, height: 72, borderRadius: 22, background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.12)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 8px" }}>
                  <Shield style={{ width: 28, height: 28, color: "#6366F1", opacity: 0.4 }} />
                </div>
              ...
              <motion.div initial={{ x: 40, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.3, ...spring }} style={{ textAlign: "center" }}>
                <div className="phone-frame phone-3d-right" style={{ width: 200, height: 400, margin: "0 auto 12px" }}>
                  <div className="phone-screen" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "44px 16px 16px" }}>
                    <Phone style={{ width: 24, height: 24, color: "#0EA5E9", opacity: 0.3, marginBottom: 12 }} />
                ...
                <span style={{ fontSize: 12, fontWeight: 600, color: "#0EA5E9" }}>Student Tutor</span>
              </motion.div>
            </div>

            <motion.button onClick={runSimulation} whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
              className="aurora-gradient"
              style={{ padding: "16px 36px", fontSize: 15, fontWeight: 700, color: "white", border: "none", cursor: "pointer", borderRadius: 18, boxShadow: "0 8px 30px rgba(99,102,241,0.3)", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 32, marginBottom: 32, width: "100%" }}>
                      ...
                      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} style={{ textAlign: "center" }}>
                        ...
                        {xRayMode && (
                          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
                            style={{ marginTop: 12, padding: "6px 12px", borderRadius: 8, background: "rgba(244,63,94,0.1)", border: "1px solid rgba(244,63,94,0.2)" }}>
                            <div style={{ fontSize: 10, color: "#F43F5E", textDecoration: "line-through" }}>+91-98765-43210</div>
                            <div style={{ fontSize: 9, fontWeight: 700, color: "#F43F5E" }}>REAL # BLOCKED</div>
                          </motion.div>
                        )}
                      </motion.div>
                    )}
                    {(stage === 2 || stage === 3) && (
                      <div style={{ textAlign: "center" }}>
                        <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 2, ease: "linear" }}>
                          <Phone style={{ width: 24, height: 24, color: "#6366F1", margin: "0 auto 8px" }} />
                        </motion.div>
                        <div style={{ fontSize: 11, color: "#6366F1" }}>Connecting...</div>
                      </div>
                    )}
                    {stage >= 4 && (
                      <div style={{ textAlign: "center" }}>
                        <div style={{ width: 48, height: 48, borderRadius: "50%", background: "rgba(14,165,233,0.12)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px" }}>
                          <PhoneCall style={{ width: 22, height: 22, color: "#0EA5E9" }} />
                        </div>
                        <div style={{ fontSize: 11, color: "#0EA5E9", marginBottom: 4 }}>Connected</div>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, minWidth: 160 }}>
                ...
                <motion.div animate={stage >= 2 ? { scale: [1, 1.05, 1] } : {}} transition={{ repeat: Infinity, duration: 2.5 }}
                  ...
                  style={{ width: 80, height: 80, borderRadius: 24, display: "flex", alignItems: "center", justifyContent: "center", background: stage >= 2 ? "rgba(99,102,241,0.12)" : "rgba(99,102,241,0.04)", border: stage >= 2 ? "2px solid rgba(99,102,241,0.4)" : "1px solid rgba(99,102,241,0.1)", transition: "all 0.5s" }}>
                  {stage >= 2 ? (
                    <motion.div initial={{ scale: 0, rotate: -90 }} animate={{ scale: 1, rotate: 0 }} transition={spring}>
                      <Lock style={{ width: 28, height: 28, color: "#6366F1" }} />
                    </motion.div>
                  ) : (<Shield style={{ width: 28, height: 28, color: "#6366F1", opacity: 0.4 }} />)}
                </motion.div>
                <span style={{ fontSize: 10, color: "#6366F1", fontWeight: 600 }}>Core Engine</span>
                {stage === 3 && (
                  <div style={{ position: "relative", width: "100%", height: 8 }}>
                    <div style={{ position: "absolute", inset: "50% 0", height: 1, background: "linear-gradient(90deg, transparent, rgba(14,165,233,0.3))" }} />
                    <motion.div animate={{ x: [0, 120], opacity: [0, 1, 1, 0] }} transition={{ duration: 1.2, repeat: Infinity }}
                      style={{ position: "absolute", left: 0, top: "50%", transform: "translateY(-50%)", width: 8, height: 8, borderRadius: "50%", background: "#0EA5E9", boxShadow: "0 0 12px rgba(14,165,233,0.8)" }} />
                  </div>
                )}
              </div>
              ...
              <div style={{ textAlign: "center", flexShrink: 0 }}>
                <motion.div className={`phone-frame phone-3d-right ${stage >= 4 ? "phone-glow-emerald" : ""}`}
                  animate={stage === 3 ? { boxShadow: "0 0 40px rgba(14,165,233,0.35)" } : {}}
                  style={{ width: 200, height: 400, margin: "0 auto 10px" }}>
                  <div className="phone-screen" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "44px 16px 16px" }}>
                    {stage < 3 && (
                      <div style={{ textAlign: "center", opacity: 0.3 }}>
                        <Phone style={{ width: 24, height: 24, color: "#0EA5E9", margin: "0 auto 8px" }} />
                    ...
                    {stage === 3 && (
                      <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} style={{ textAlign: "center" }}>
                        <motion.div animate={{ scale: [1, 1.15, 1] }} transition={{ repeat: Infinity, duration: 1 }}>
                          <PhoneIncoming style={{ width: 32, height: 32, color: "#0EA5E9", margin: "0 auto 12px" }} />
                        </motion.div>
                        ...
                        {xRayMode && (
                          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
                            style={{ marginTop: 12, padding: "6px 12px", borderRadius: 8, background: "rgba(244,63,94,0.1)", border: "1px solid rgba(244,63,94,0.2)" }}>
                            <div style={{ fontSize: 10, color: "#F43F5E", textDecoration: "line-through" }}>+91-91234-56789</div>
                            <div style={{ fontSize: 9, fontWeight: 700, color: "#F43F5E" }}>REAL # BLOCKED</div>
                          </motion.div>
                        )}
                      </motion.div>
                    ...
                    {stage >= 4 && (
                      <div style={{ textAlign: "center" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 2, marginTop: 16, height: 28 }}>
                          {Array.from({ length: 10 }).map((_, i) => (<span key={i} className="waveform-bar" style={{ background: "#0EA5E9" }} />))}
                        </div>
                      </div>
                    )}
                  </div>
                </motion.div>
                <span style={{ fontSize: 11, color: "#0EA5E9", fontWeight: 600 }}>Student Tutor</span>
              </div>
            </div>
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, ...spring }}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
                    ...
                    <motion.div initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 2 }}
                      ...
                      <div style={{ padding: "10px 16px", borderRadius: 16, borderBottomRightRadius: 4, background: "rgba(14,165,233,0.08)", border: "1px solid rgba(14,165,233,0.12)", maxWidth: "80%" }}>
                        <p style={{ fontSize: 13, color: "var(--text-secondary)", margin: 0 }}>&quot;Yes! Practice sheets are ready.&quot;</p>
                      </div>
                      <div style={{ width: 28, height: 28, borderRadius: 10, background: "rgba(14,165,233,0.12)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        <span style={{ fontSize: 10, fontWeight: 800, color: "#0EA5E9" }}>R</span>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  <AnimatePresence>
                    {stage >= 5 && (
                      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, ...spring }}
                        style={{ padding: 28, borderRadius: 24, background: "linear-gradient(135deg, rgba(99,102,241,0.06), rgba(41,151,255,0.03))", border: "1px solid rgba(99,102,241,0.12)" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                          {[
                            { label: "Leakage Risk", value: "0%", color: "#0EA5E9" },
                            { label: "Margin Retained", value: "100%", color: "#2997FF" },
                            { label: "Compliance", value: "Encrypted", color: "#6366F1" },
                          ].map((m) => (
                        ...
                        <div style={{ marginTop: 16, padding: 12, borderRadius: 14, border: "1px solid rgba(14,165,233,0.15)", background: "rgba(14,165,233,0.04)", textAlign: "center" }}>
                          <CheckCircle2 style={{ width: 14, height: 14, color: "#0EA5E9", display: "inline", verticalAlign: "middle", marginRight: 6 }} />
                          <span style={{ fontSize: 11, fontWeight: 700, color: "#0EA5E9" }}>MERCHANTS CANNOT BYPASS STUDGOO</span>
                        </div>
                      </motion.div>
                    )}
                  </AnimatePresence>
      ...
      <div style={{ padding: "16px 36px 24px", borderTop: "1px solid var(--border)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} onClick={runSimulation} disabled={isRunning}
            style={{ padding: "8px 18px", fontSize: 12, fontWeight: 700, borderRadius: 12, border: "none", cursor: isRunning ? "not-allowed" : "pointer", background: "rgba(99,102,241,0.1)", color: "#6366F1", opacity: isRunning ? 0.3 : 1 }}>
            ▶ Run Simulation
          </motion.button>
          ...
          <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} onClick={() => setXRayMode(!xRayMode)}
            style={{ padding: "8px 18px", fontSize: 12, fontWeight: 600, borderRadius: 12, border: "none", cursor: "pointer", background: xRayMode ? "rgba(244,63,94,0.1)" : "rgba(255,255,255,0.04)", color: xRayMode ? "#F43F5E" : "var(--text-secondary)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          {stagesLabel.map((label, i) => (
            <div key={label} style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: stage === i ? "#6366F1" : stage > i ? "#0EA5E9" : "var(--elevated)", boxShadow: stage === i ? "0 0 8px rgba(99,102,241,0.6)" : "none", transition: "all 0.3s" }} />
              <span style={{ fontSize: 10, fontWeight: 600, color: stage === i ? "#6366F1" : stage > i ? "#0EA5E9" : "var(--text-tertiary)" }}>{label}</span>
              {i < stagesLabel.length - 1 && <div style={{ width: 16, height: 1, background: stage > i ? "#0EA5E9" : "var(--elevated)", transition: "background 0.3s" }} />}
            </div>
          ))}
        </div>
      </div>
